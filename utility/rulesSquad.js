...
\`\`\`
  ...
  ▹ 1.7. Запрещено использование никнейма другого игрока или клан-тэга без разрешения.
  ▹ 1.8. Любое действие, использующее ошибки игры и направленное на достижение положительного результата, является абьюзом игровых механик и категорически запрещено.
  ▹ 1.9. Запрещено передавать информацию об оставшихся тикетах, местах расположения хабов, техники, маршрутах и прочую, которая способна помешать победе Вашей команды, за исключением общедоступной трансляции (стрима). Запрещено распространять и использовать такую информацию, если она была получена благодаря смене стороны или посредством тайной передачи от другой стороны, а также на стриме.
  ▹ 1.10. Запрещено использовать любые способы наведения АГС и MK19, кроме стандартной прицельной сетки.
\`\`\``
  );
...
\`\`\`
  ...
  ▹ 2.5. Командир отряда обязан иметь микрофон, говорить по-русски и поддерживать связь в командирском канале по запросу.
  ▹ 2.6. Создание отряда и переброс роли командира без согласования запрещено. При ошибочном создании отряда необходимо его распустить.
  ▹ 2.7. Отряд в лице одного “Squad Leader” не может быть закрыт, кроме использования боевой легкой техники для фракций MEI (Middle Eastern Insurgents), IMF (Irregular Militia Forces), CRF (Canadian Resistance Forces).
  ▹ 2.8. Сквадной имеет право кикать бойцов на свое усмотрение без объяснения причин.
  ▹ 2.9. Приказы командира стороны (CMD) не обязательны к исполнению.
\`\`\``);
...
\`\`\`
  ▹ 3.1. Пехотные и технические отряды, выполняющие боевые задачи на актуальных игровых точках (атака/защита), имеют наивысший приоритет при снабжении ресурсами и распределении легкой техники на мейне.
  ▹ 3.2. Пехотный отряд - командир имеет снаряжение 'Командир' (Lead), (Leader). Численность от 2 до 9 человек.
  ▹ 3.3. Технический отряд - использует тяжелую технику, командир имеет снаряжение "Командир Экипажа" (Lead Crewman). Численность до 9 человек.
  ▹ 3.4. Отряд поддержки - занимается ИСКЛЮЧИТЕЛЬНО блоком мейна/ПТУР/минометами/пушками. Численность до 6 человек.
Отряд из одного человека считается отрядом поддержки и имеет низший приоритет при распределении легкой техники на мейне.
  ▹ 3.5. Отряд авиации - использует вертолет, командир имеет снаряжение 'Летчик Командир' (Lead Pilot). Численность до 4 человек.
  ▹ 3.6. Легкая техника - не требует снаряжения 'Член экипажа' (Crewman) или 'Летчик' (Pilot).
  ▹ 3.7. Тяжелая техника - требует снаряжения 'Член экипажа' (Crewman).
\`\`\``);
...
\`\`\`
  ▹ 4.1. Любая техника имеет большое значение, поэтому запрещено подвергать ее лишнему риску и безответственно к ней относиться.
  ▹ 4.2. Использование тяжелой техники разрешено только в количестве одной на отряд, с экипажем из командира со снаряжением 'Командир Экипажа' (Lead Crewman) и минимум одного бойца со снаряжением 'Член экипажа' (Crewman), кроме случаев перемещения на мейн или ремонт.
  ▹ 4.3. Первоочередной задачей технического отряда при потере тяжелой техники является ее спасение. Запрещено использование другой тяжелой техники, если предыдущая находится вне мейна.
  ▹ 4.4. Использование вертолета разрешено только в количестве одного на отряд и командиром со снаряжением 'Летчик Командир' (Lead Pilot) в составе экипажа.
  ▹ 4.5. Запрещено использование вертолета без необходимых навыков управления.
  ▹ 4.6. Реклейм тяжелой техники без разрешения запрещен вне мейна, но на мейне разрешен.
